...
% TODO falar sobre grafo 1-colorivel, 2 colorivel, etc.
...
\end{algorithm}\ % FIXME precisa pular 1 linha do box do algoritmo usando a barra?
...
% Jeff: meu feeling é que seja, de fato O(n). Vou precisar provar isso.
...
\begin{algorithm}[H]
  ...
  \SetAlgoLined
  \KwData{uma clique de G}
  \KwResult{uma clique maximal}
...
% TODO encontrar outras heurísticas disponíveis.
...
% TODO citar quais outros avanços - teorema das 5 cores.
